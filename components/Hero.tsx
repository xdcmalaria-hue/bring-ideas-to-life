...
const DrawingTransformation = ({ 
  ...
  return (
    ...
    >
      <div className={`relative w-20 h-28 md:w-28 md:h-40 rounded-lg backdrop-blur-md transition-all duration-1000 ${stage === 2 ? 'bg-white border-zinc-200 shadow-xl scale-110 -translate-y-4 dark:bg-zinc-800/40 dark:border-zinc-500/50' : 'bg-white/50 border-zinc-300 scale-100 border border-dashed dark:bg-zinc-900/10 dark:border-zinc-800'}`}>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <div className={`absolute transition-all duration-1000 ${stage === 1 ? 'opacity-100' : 'opacity-0'}`}>
             ...
             <div className="absolute -inset-2 border border-zinc-300 dark:border-zinc-700/30 opacity-50"></div>
          ...
          <div className={`absolute transition-all duration-700 flex flex-col items-center ${stage === 2 ? 'opacity-100 scale-100 blur-0' : 'opacity-0 scale-75 blur-sm'}`}>
             ...
             {stage === 2 && (
               <div className="mt-3 flex items-center gap-2 px-2 py-1 bg-zinc-100 dark:bg-zinc-900/80 rounded-full border border-zinc-200 dark:border-zinc-700/50">
                 <div className="w-1 h-1 bg-green-500 rounded-full"></div>
                 <div className="w-8 h-0.5 bg-zinc-300 dark:bg-zinc-700 rounded-full overflow-hidden">
  ...
  return (
    <>
      ...
      <div className="text-center relative z-10 max-w-6xl mx-auto px-4 pt-8">
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tighter text-zinc-900 dark:text-white mb-6 leading-[1.1] transition-colors duration-300">
          Bring anything <br/>
          to <span className="underline decoration-4 decoration-blue-500 underline-offset-4 md:underline-offset-8 text-zinc-900 dark:text-white transition-colors duration-300">life</span>.
        </h1>
        <p className="text-base sm:text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed font-light transition-colors duration-300">
